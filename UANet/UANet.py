...
class Uncertainty_Aware_Fusion_Module(nn.Module):
    ...
    def forward(self, feature_low, feature_high, map):
        ...
        uncertainty_high_up = F.interpolate(self.conv_high(uncertainty_feature_high), feature_low.size()[2:],
        ...
        uncertainty_feature_low = torch.cat(
            (uncertainty_fore_map_low * feature_low, uncertainty_back_map_low * feature_low), dim=1)
...
class UANet_Res50(nn.Module):
    def __init__(self, channel, num_classes):
        ...
        self.backbone = resnet50(backbone_path="resnet50-11ad3fa6.pth")
        ...
        self.ufm_layer4 = Uncertainty_Aware_Fusion_Module(high_channel=channel, low_channel=channel,
                                                          out_channel=channel, num_classes=num_classes)
        self.ufm_layer3 = Uncertainty_Aware_Fusion_Module(high_channel=channel, low_channel=channel,
                                                          out_channel=channel, num_classes=num_classes)
        self.ufm_layer2 = Uncertainty_Aware_Fusion_Module(high_channel=channel, low_channel=channel,
                                                          out_channel=channel, num_classes=num_classes)
        self.ufm_layer1 = Uncertainty_Aware_Fusion_Module(high_channel=channel, low_channel=channel,
                                                          out_channel=channel, num_classes=num_classes)
